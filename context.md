...
> Last Updated: 2026-05-30 (v8.1-phase2 — per-strategy magic + conflict filter + risk ledger, bot_state schema 9; MR unchanged when `tf.enabled` OFF) | Scope: Hub / Index — read this first, then drill into wiki/*
