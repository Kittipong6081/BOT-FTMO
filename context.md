...
> Last Updated: 2026-05-30 (v8.1-phase1 — Regime gate + Router + TF rules scanner, behind `tf.enabled` flag, default OFF) | Scope: Hub / Index — read this first, then drill into wiki/*
