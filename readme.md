...
>
> ตอนเปิด TF: บอทจะแบ่งงานตามสภาพตลาด — ตลาดออกข้าง→MR, ตลาดเทรนด์→TF (ทำให้ MR เทรดน้อยลงเพราะถูกจำกัดเฉพาะตลาดออกข้าง). ⚠️ **คำเตือนตรง ๆ**: TF เดี่ยว ๆ ผ่านแค่ ~6.8% และ **ยังไม่ผ่านการทดสอบเงินปลอม (paper-forward)** — ช่องว่างซ้อม↔จริงนี่แหละที่ทำบัญชีก่อนตาย (−9.87%). **แนะนำ: รัน `BOT_TF_ENABLED=1` บน demo ก่อน ≥2–4 สัปดาห์** แล้วค่อยเปิดบนบัญชีจริง. ถ้าอยากให้เปิดถาวรบนเครื่องไหน ใส่ `BOT_TF_ENABLED=1` ใน `.env` ของเครื่องนั้น. ดู [`wiki/04-operations.md`](wiki/04-operations.md).
>
